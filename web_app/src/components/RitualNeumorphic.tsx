  ...
  return (
    <div className="container fade-in" style={{ justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
        <h1 className="screen-title">Reset Ritual</h1>
        <p className="screen-subtitle">Grounding through physiology.</p>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <button 
          className="soft-btn" 
          style={{ marginTop: '8rem', padding: '15px 30px', borderRadius: '30px' }}
